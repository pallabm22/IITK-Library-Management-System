...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="container">
        <div class="innerdiv">
            <div class="row"><img class="imglogo" src="images/logo2.jpg" style="width:910px; height: 175px;" /></div>
            <div class="leftinnerdiv">
                <!-- <Button class="greenbtn"> ADMIN</Button> -->
                <br>
                <Button class="greenbtn" onclick="openpart('addbook')" >  ADD BOOK</Button>
                <Button class="greenbtn" onclick="openpart('bookreport')" >  BOOK DETAILS</Button>
                ...
                <Button class="greenbtn" onclick="openpart('studentrecord')"> STUDENT DETAILS</Button>
